      ...
      <div className="bg-white" id="hotels-list">
        <div className="max-w-2xl mx-auto pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <h2 className="text-xl font-extrabold tracking-tight text-gray-900 sm:text-xl">
            {hotels.length === 0
              ? "There are not available hotels"
              : "Available hotels"}
          </h2>
                    ...
                    <li key={hotelIdx} className="flex py-6 sm:py-10">
                      <div className="flex-shrink-0">
                        <Image
                          ...
                          src={`${
                            process.env.NEXT_PUBLIC_URL_SERVICE_HOTELS
                          }/api/public/${
                            hotel.thumbnail ?? "missing_hotel.png"
                          }`}
                          alt={hotel.title}
                          width={1000}
                          height={1000}
                      ...
                      <div>
                        <Link
                          href={`/hotel/${hotel.hotel_id}?check_in_date=${router.query.check_in_date}&check_out_date=${router.query.check_out_date}`}>
